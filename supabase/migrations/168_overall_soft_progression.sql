-- OVR v8: favorece a característica mais forte sem punir versatilidade,
-- substitui o degrau rígido semanal por progressão suave e encerra o estado
-- provisório ao completar três rodadas oficiais.

insert into public.overall_formula_versions (key, label, config)
values (
  'adaptive-v8-soft-progression-shadow',
  'OVR adaptativo v8 — progressão suave por características',
  jsonb_build_object(
    'base', 70,

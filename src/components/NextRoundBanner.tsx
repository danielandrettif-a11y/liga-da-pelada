...
export function NextRoundBanner({ round }: { round: NextRound | null }) {
  ...
  return (
    <Link href={href} className="group block" aria-label={round ? "Abrir próxima rodada" : "Abrir central de rodadas"}>
      <div className="relative isolate h-[300px] overflow-hidden rounded-[28px] border border-sky-400/30 bg-[#07131a] p-5 shadow-[0_22px_60px_rgba(0,0,0,.38),0_0_28px_rgba(56,189,248,.08)] sm:p-6">

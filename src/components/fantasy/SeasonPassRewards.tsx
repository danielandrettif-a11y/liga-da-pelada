...
export function SeasonPassRewards({ pass, cosmetics, rewardId }: { pass: SeasonPassDashboard; cosmetics: CosmeticsDashboard; rewardId?: string }) {
  ...
  return <><SeasonPassBoard progress={pass.progress} playerName={pass.playerName} playerAvatarUrl={pass.playerAvatarUrl} rewards={cosmetics.rewards} onOpenReward={setOpenReward} /><PassRewardPicker reward={openReward} progress={pass.progress} onClose={() => setOpenReward(null)} /></>;
}

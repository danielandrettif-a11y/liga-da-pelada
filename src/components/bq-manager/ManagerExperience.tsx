...
function Rules() {
  return <details className={`${styles.panel} ${styles.rules}`}><summary>Como funcionam as cartas e o OVR?</summary><div className={styles.stack}>
    ...
    <p><b>OVR geral.</b> Cartas atuais usam as três melhores posições em 50%, 35% e 15%. Cartas legadas preservam a fórmula gravada quando foram adquiridas. GOL só participa depois da amostra necessária.</p>

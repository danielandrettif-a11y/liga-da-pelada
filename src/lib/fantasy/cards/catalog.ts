...
export const FANTASY_CARDS_CATALOG: FantasyCardDefinition[] = [
  ...
  },
  {
    ...
    name: "Vice-Capitão",
    icon: "🛡️",
    description: "Se o seu Capitão oficial não entrar em campo, o Vice-Capitão assume o multiplicador 2x.",
    rarity: "RARE",
  ...
  },
  {
    ...
    icon: "🔄",
    description: "Um 6º jogador entra no lugar de um titular que não jogou.",
    rarity: "EPIC",

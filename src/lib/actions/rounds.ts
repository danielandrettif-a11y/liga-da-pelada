...
export async function createRoundWithTeams(
  ...
  try {
    ...
    const formationMode: TeamFormationMode = options.formationMode === "random" || options.formationMode === "balanced" || options.formationMode === "speed" || options.formationMode === "adaptive"
